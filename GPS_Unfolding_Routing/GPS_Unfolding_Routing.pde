...
//
String baseString = "./data/";///Users/swise/Projects/FTC/CSV/"; // prefix for csv files (numbered 0-n)
int selectOneFile = 2; // -1 to draw all tracks at once, 0+ to draw each track individually
int maxFile = 2;
